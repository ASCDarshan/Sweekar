// src/components/landing/ConcernsSection.jsx
          ...
          {concerns.map((concern) => (
            <Chip
              ...
              sx={{
                borderRadius: '16px',
                px: 2,
                backgroundColor: selectedConcerns.includes(concern) ? 'primary.main' : 'grey.100',
                color: selectedConcerns.includes(concern) ? 'white' : 'text.primary',
                '&:hover': {
